...
export namespace Models {
  ...
  export namespace Istio {
    type ISidecarCaptureMode = 'DEFAULT' | 'IPTABLES' | 'NONE'
    ...
    export interface ISidecar extends IBaseResource {
      ...
      spec: {
        egress: {
          ...
          port?: IServicePort
          bind?: string
          captureMode?: ISidecarCaptureMode
        }[]
        ingress?: {
          port: IServicePort
          bind?: string
  ...
  export namespace Core {
    ...
    /**
     * Represents v1.ConfigMap
     */
    export interface IConfigMap extends BaseResource<ConfigMap> {}
